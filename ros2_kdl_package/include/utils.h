...
{
    return KDL::Frame(KDL::Rot(KDL::Vector(v[3],0,0))*
                      KDL::Rot(KDL::Vector(0,v[4],0))*
                      KDL::Rot(KDL::Vector(0,0,v[5])),
                      KDL::Vector(v.at(0),v.at(1),v.at(2)));
}

inline KDL::Frame toKDL(KDL::Vector& v)
{
    return KDL::Frame(KDL::Rot(KDL::Vector(v[3],0,0))*
                      KDL::Rot(KDL::Vector(0,v[4],0))*
                      KDL::Rot(KDL::Vector(0,0,v[5])),
...
inline Eigen::Matrix<double,3,3> getL(const Eigen::Matrix<double,3,3> &_R_d,
                                      const Eigen::Matrix<double,3,3> &_R_e)
{
    Eigen::Matrix3d L = -0.5*(skew(_R_d.col(0))*skew(_R_e.col(0)) +
                              skew(_R_d.col(1))*skew(_R_e.col(1)) +
